...
public class ScaleMoney extends View {
    private static final String TAG = ScaleMoney.class.getSimpleName();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        LogUtil.e(TAG,"当前值为" + (-lastMoveX + mWidth / 2 + 7) / 13 + "原值为" + (-lastMoveX + mWidth / 2));
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (moveX < 0) {
                    ...
                    //向右滑动
                    isLeft = false;
                    LogUtil.e(TAG,"向右滑动lastMoveX" + lastMoveX);
    ...
    private void initSize() {
        LogUtil.e(TAG,"getHeight" + getHeight());
        mStartY = getHeight() / 2;
        mWidth = getWidth();
    }
