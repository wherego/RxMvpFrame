...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    int indicatorPaddingLeftRight = 5;
     ...
     * 设置指示器左右边距多少
     *
     * @param indicatorPaddingLeftRight
     */
    public void setIndicatorPaddingLeftRight(int indicatorPaddingLeftRight) {
        this.indicatorPaddingLeftRight = indicatorPaddingLeftRight;
    }

    /**
     * 设置指示器是否跟字体一样大小
     *
     * @param flag true 跟随字体一样大小
     */
    public void setIndicatorPadding(boolean flag) {
        indicatorPadding = flag ? tabPadding - indicatorPaddingLeftRight : 0;
    }
    ...
    private int tabTextColor = 0x666666;
