...
/**
 * Author：Jalen on 2016/7/26 22:56
 * Contact: studylifetime@sina.com
 */
public class Constant {
    //服务器上的地址
    public static final String BaseURL = "http://service.vboxiu.com";
    //本地测试的地址
    public static final String BaseURL_Local = "http://10.0.0.2";
    //下载测试地址
    public static final String BaseURL_DownLoad = "http://music.baidu.com/cms/";
    //测试Header
    public static final String BaseURL_Bmob = " https://api.bmob.cn/1/classes/";
...
//    public static final int SDK_APPID = 1400001533;
    ...
    // 多人互动消息类型
    public static final int AVIMCMD_MULTI = 0x800;
    // 多人主播发送邀请消息, C2C消息
    public static final int AVIMCMD_MUlTI_HOST_INVITE = AVIMCMD_MULTI + 1;
    // 断开互动，Group消息，带断开者的imUsreid参数
    public static final int AVIMCMD_MULTI_CANCEL_INTERACT = AVIMCMD_MUlTI_HOST_INVITE + 1;
    // 多人互动方收到AVIMCMD_Multi_Host_Invite多人邀请后，同意，C2C消息
    public static final int AVIMCMD_MUlTI_JOIN = AVIMCMD_MULTI_CANCEL_INTERACT + 1;
    // 多人互动方收到AVIMCMD_Multi_Invite多人邀请后，拒绝，C2C消息
    public static final int AVIMCMD_MUlTI_REFUSE = AVIMCMD_MUlTI_JOIN + 1;
    // 主播打开互动者Mic，C2C消息
    public static final int AVIMCMD_Multi_Host_EnableInteractMic = AVIMCMD_MUlTI_REFUSE + 1;
    // 主播关闭互动者Mic，C2C消息
    public static final int AVIMCMD_Multi_Host_DisableInteractMic = AVIMCMD_Multi_Host_EnableInteractMic + 1;
    // 主播打开互动者Camera，C2C消息
    public static final int AVIMCMD_Multi_Host_EnableInteractCamera = AVIMCMD_Multi_Host_DisableInteractMic + 1;
    // 主播打开互动者Camera，C2C消息
    public static final int AVIMCMD_Multi_Host_DisableInteractCamera = AVIMCMD_Multi_Host_EnableInteractCamera + 1;
    ...
    // 无事件
    public static final int AVIMCMD_None = AVIMCMD_Text + 1;

    // 以下事件为TCAdapter内部处理的通用事件

    // 用户加入直播, Group消息  1
    public static final int AVIMCMD_EnterLive = AVIMCMD_None + 1;
    // 用户退出直播, Group消息  2
    public static final int AVIMCMD_ExitLive = AVIMCMD_EnterLive + 1;
    // 点赞消息, Demo中使用Group消息  3
    public static final int AVIMCMD_Praise = AVIMCMD_ExitLive + 1;
    // 主播离开, Group消息 ： 4
    public static final int AVIMCMD_Host_Leave = AVIMCMD_Praise + 1;
    // 主播回来, Demo中使用Group消息 ： 5
    public static final int AVIMCMD_Host_Back = AVIMCMD_Host_Leave + 1;
...
//    //权限位；TODO：默认值是拥有所有权限。
//    public static final long HOST_AUTH = AVRoom.AUTH_BITS_DEFAULT;
//    //权限位；TODO：默认值是拥有所有权限。
//    public static final long VIDEO_MEMBER_AUTH = AVRoom.AUTH_BITS_DEFAULT;
